...
g++ -std=c++17 -I src tests/query/QueryExecutorTest.cpp src/parser/Tokenizer.cpp src/parser/SQLParser.cpp src/parser/AST.cpp src/query/QueryExecutor.cpp src/storage/StorageManager.cpp src/utils/Print.cpp -o build/QueryExecutorTest.exe
if %errorlevel% neq 0 ( echo COMPILE FAILED & exit /b %errorlevel% )
